...
updateClass('lib/Maplat/Worker/Logging.pm', 'lib/Maplat/Worker/Logging', 'Maplat::Worker::Logging::');
updateClass('lib/Maplat/Web/Logging.pm', 'lib/Maplat/Web/Logging', 'Maplat::Web::Logging::');
print "Done\n";
